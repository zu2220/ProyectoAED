...
public class frmVerSeccionesCreadas extends javax.swing.JFrame {
    ...
    private void mostrarLista() {
        for(int i=0;i<LS.getSize();i++){
            String codigoAula=LS.getNodoByIndex(i).getDato().getCodigoAula();
            String curso=LS.getNodoByIndex(i).getDato().getCurso().getNombreCurso();
            String profesor=LS.getNodoByIndex(i).getDato().getDocenteACargo().getNombre();
